...
export function ArchetypeQuiz({ onClose }: ArchetypeQuizProps) {
  ...
  const saveAssessmentMutation = useMutation({
    mutationFn: (data: any) => apiRequest('/api/users/me/archetype', 'POST', data),
    onSuccess: () => {
    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-holo-gold mb-2">Your Village Archetype</h2>
          <div className="text-4xl font-bold text-electric-green mb-4">{primaryArchetype}</div>
          <p className="text-gray-300">
            Based on your responses, this archetype best matches your skills and interests for village life.
          </p>
        </div>
        ...
        <div className="flex justify-end space-x-2">
          <Button variant="outline" onClick={onClose} data-testid="button-discard-results">
            Take Again
          </Button>
          <Button 
          ...
          >
            {saveAssessmentMutation.isPending ? "Saving..." : "Save Results"}
          </Button>
        </div>
      </div>
    );
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <div className="flex justify-between items-center">
          <h2 className="text-xl font-semibold text-holo-gold">Village Archetype Assessment</h2>
      ...
      <div className="flex justify-between">
        ...
        <div className="space-x-2">
          <Button variant="outline" onClick={onClose} data-testid="button-cancel-quiz">
            Cancel
          </Button>
          <Button 
            onClick={handleNext}
