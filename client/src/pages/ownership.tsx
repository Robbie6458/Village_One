...
import { ArrowUp, ArrowDown, MessageCircle, Plus, Users, Scale, TrendingUp, Building } from "lucide-react";
      ...
      <div className="min-h-screen bg-gradient-to-b from-void to-space texture-organic pt-20">
        <div className="max-w-6xl mx-auto px-6 py-12">
          <div className="text-center">
            ...
            <p className="text-gray-400 mt-4">Loading ownership discussions...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-neon-cyan to-electric-green rounded-xl flex items-center justify-center">
              <Scale className="text-space" size={28} />
            </div>
            <h1 className="text-5xl font-cyber font-bold text-neon-cyan" data-testid="text-ownership-title">
              Ownership
            </h1>
          </div>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Legal structures, equity models, and governance frameworks for shared community ownership
          </p>
            ...
            <Card className="max-w-2xl mx-auto bg-gradient-to-r from-void to-purple-deep border-purple-deep/50 mb-8">
              <CardHeader className="pb-4">
                <div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gradient-to-br from-neon-cyan to-electric-green rounded-lg flex items-center justify-center animate-pulse">
                    <TrendingUp className="text-space" size={16} />
                  </div>
                  <CardTitle className="text-lg text-neon-cyan" data-testid="text-ai-analysis">AI Forum Analysis</CardTitle>
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-neon-cyan to-electric-green text-space font-bold py-3 px-6 rounded-lg hover:scale-105 transition-transform duration-300"
        ...
        {showNewPostForm && (
          <Card className="max-w-4xl mx-auto mb-8 bg-gradient-to-r from-void to-purple-deep border-purple-deep/50">
            <CardHeader>
              <CardTitle className="text-neon-cyan" data-testid="text-new-post-title">New Ownership Discussion</CardTitle>
              <CardDescription>Share ideas about legal structures, governance models, or equity frameworks</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              />
              <Textarea
                placeholder="Describe your ownership model, legal structure, or governance idea..."
              ...
              <div className="flex justify-end space-x-3">
                ...
                <Button
                  ...
                  className="bg-neon-cyan text-space hover:bg-neon-cyan/80"
        ...
        <div className="space-y-6">
          {posts?.map((post) => (
            <Card 
              key={post.id} 
              className="bg-gradient-to-r from-void to-purple-deep border-purple-deep/50 hover:border-neon-cyan/50 transition-all duration-300"
              data-testid={`post-${post.id}`}
            >
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <CardTitle className="text-white mb-2 hover:text-neon-cyan transition-colors cursor-pointer" data-testid={`post-title-${post.id}`}>
                      {post.title}
                    </CardTitle>
                    <div className="flex items-center space-x-4 text-sm text-gray-400">
                      <span>by {post.author?.username || 'Anonymous'}</span>
                      <span className="text-neon-cyan">{post.author?.archetype || 'Village Builder'}</span>
              ...
              <CardContent>
                ...
                {selectedPost === post.id && (
                  <div className="mt-6 pt-6 border-t border-purple-deep/50">
                    ...
                    <div className="mb-6">
                      <Textarea
                        placeholder="Add your thoughts on this ownership model..."
                        value={newComment}
            ...
            <Card className="bg-gradient-to-r from-void to-purple-deep border-purple-deep/50 text-center py-12">
              <CardContent>
                ...
                <p className="text-gray-400 mb-6">
                  Start the conversation about Village-One's ownership structures and governance
                </p>
                <Button
