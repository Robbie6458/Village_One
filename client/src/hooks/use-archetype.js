...
export function useArchetype() {
    const archetypeMutation = useMutation({
        mutationFn: (responses) => apiRequest('POST', '/api/archetype', { responses }),
    });
    const determineArchetype = (responses) => {
        ...
        Object.entries(responses).forEach(([questionId, answer]) => {
            switch (questionId) {
                case "motivation":
                    if (answer === "building")
                        scoreMap["Resident Builder"] += 3;
                    if (answer === "growing")
                        scoreMap["Horticulturist"] += 3;
                    if (answer === "connecting")
                        scoreMap["Signals Team"] += 3;
                    if (answer === "designing")
                        scoreMap["Designer"] += 3;
                    if (answer === "engineering")
                        scoreMap["Village Engineer"] += 3;
                    if (answer === "funding")
                        scoreMap["Funder"] += 3;
                    if (answer === "organizing")
                        scoreMap["Builder"] += 3;
                    break;
                case "skills":
                    if (answer === "craftsmanship")
                        scoreMap["Resident Builder"] += 2;
                    if (answer === "agriculture")
                        scoreMap["Horticulturist"] += 2;
                    if (answer === "communication")
                        scoreMap["Signals Team"] += 2;
                    if (answer === "creativity")
                        scoreMap["Designer"] += 2;
                    if (answer === "technology")
                        scoreMap["Village Engineer"] += 2;
                    if (answer === "finance")
                        scoreMap["Funder"] += 2;
                    if (answer === "logistics")
                        scoreMap["Builder"] += 2;
                ...
                case "contribution":
                    if (answer === "hands-on")
                        scoreMap["Resident Builder"] += 2;
                    if (answer === "cultivation")
                        scoreMap["Horticulturist"] += 2;
                    if (answer === "facilitation")
                        scoreMap["Signals Team"] += 2;
                    if (answer === "vision")
                        scoreMap["Designer"] += 2;
                    if (answer === "infrastructure")
                        scoreMap["Village Engineer"] += 2;
                    if (answer === "investment")
                        scoreMap["Funder"] += 2;
                    if (answer === "coordination")
                        scoreMap["Builder"] += 2;
                    break;
                case "problem_solving":
                    if (answer === "prototype")
                        scoreMap["Resident Builder"] += 1;
                    if (answer === "research")
                        scoreMap["Horticulturist"] += 1;
                    if (answer === "collaborate")
                        scoreMap["Signals Team"] += 1;
                    if (answer === "visualize")
                        scoreMap["Designer"] += 1;
                    if (answer === "analyze")
                        scoreMap["Village Engineer"] += 1;
                    if (answer === "strategize")
                        scoreMap["Funder"] += 1;
                    if (answer === "plan")
                        scoreMap["Builder"] += 1;
                    break;
                case "legacy":
                    ...
                    if (answer === "connections")
                        scoreMap["Signals Team"] += 1;
                    if (answer === "inspiration")
                        scoreMap["Designer"] += 1;
                    if (answer === "innovation")
                        scoreMap["Village Engineer"] += 1;
                    if (answer === "sustainability")
                        scoreMap["Funder"] += 1;
                    if (answer === "efficiency")
                        scoreMap["Builder"] += 1;
                    break;
            }
        });
        // Find the archetype with the highest score
        const topArchetype = Object.entries(scoreMap).reduce((a, b) => scoreMap[a[0]] > scoreMap[b[0]] ? a : b)[0];
        return topArchetype;
    };
    const getArchetypeDescription = (archetype) => {
        ...
        return descriptions[archetype] || "A valuable contributor to the Village-One community.";
    };
    const getArchetypeColor = (archetype) => {
        ...
        return colors[archetype] || "gray-400";
    };
    return {
